        ...
        public ResponseEntity<HttpResponse> createRating(@RequestBody RatingRequest req,
                ...
                try {
                        ...
                        return ResponseEntity.status(HttpStatus.CREATED).body(HttpResponse.builder()
                                        .timeStamp(LocalDateTime.now().toString()).data(Map.of("rating", rating))
                                        .message("Rating created successfully").status(HttpStatus.CREATED)
        ...
        public ResponseEntity<HttpResponse> getProductsRating(@PathVariable Long productId,
                ...
                try {
                        ...
                        return ResponseEntity.ok(HttpResponse.builder().timeStamp(LocalDateTime.now().toString())
                                        .data(Map.of("ratings", ratings)).message("Ratings fetched successfully")
