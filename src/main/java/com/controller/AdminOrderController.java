...
public class AdminOrderController {
    ...
    public ResponseEntity<HttpResponse> deliverOrderHandler(@PathVariable Long orderId,
            @RequestHeader("Authorization") String jwt) {
        try {
    ...
    public ResponseEntity<HttpResponse> cancelOrderHandler(@PathVariable Long orderId,
            @RequestHeader("Authorization") String jwt) {
        try {
